...
\def \version {2023/12/18}	% VERSION variable
...
\newcommand{\iconls}[2]{\lower\iconLower\hbox{\csname #1\endcsname}&\textbackslash#1&#2}
\newcommand{\iconsc}[1]{\lower\iconLower\hbox{\csname #1\endcsname}&\textbackslash#1}
