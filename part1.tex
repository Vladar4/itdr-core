...
\end{multicols}
\vspace{-\baselineskip}\noindent\rule{0.5\linewidth}{1pt}\vspace{1ex}\\
...
For details on footnotes, see \href{https://www.ctan.org/pkg/sepfootnotes}{sepfootnotes} package.
...
\fbox{\lstinline!\{./img/\} \{./img/pic/\} \{./pic/\} \{./core/img/\}!}\\
